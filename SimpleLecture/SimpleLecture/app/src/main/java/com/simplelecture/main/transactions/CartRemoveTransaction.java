 ...
 */
public class CartRemoveTransaction extends GetTransaction {

    private String mUrlEncoded;

    private String mHeaderVal;

    public CartRemoveTransaction(JSONObject jsonObject, Context context, String urlEncoded, String headerVal) {
    ...
    protected String getUrlPrefix() {
        return Constants.GET_CART_REMOVE + mUrlEncoded;
    }
