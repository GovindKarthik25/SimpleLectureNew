 ...
 */
public class CartDetailsTransaction extends GetTransaction {

    private String mUrlEncoded;

    private String mHeaderVal;

    public CartDetailsTransaction(JSONObject jsonObject, Context context, String urlEncoded, String headerVal) {
    ...
    protected String getUrlPrefix() {
        return Constants.GET_CART_ALL + mUrlEncoded;
    }
