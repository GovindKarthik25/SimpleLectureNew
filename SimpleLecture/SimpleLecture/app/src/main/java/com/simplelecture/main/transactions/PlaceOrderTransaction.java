 ...
 */
public class PlaceOrderTransaction extends PostTransaction {

    JSONObject jsonObject;

    public PlaceOrderTransaction(JSONObject jsonObject, Context context) {
    ...
    protected String getUrlPrefix() {
        return Constants.GET_ORDER_PLACEORDER;
    }
