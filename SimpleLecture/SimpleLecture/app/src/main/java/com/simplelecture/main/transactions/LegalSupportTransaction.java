 ...
 */
public class LegalSupportTransaction extends GetTransaction {

    private String mUrlEncoded;

    private String mHeaderVal = "";

    public LegalSupportTransaction(JSONObject jsonObject, Context context) {
    ...
    protected String getUrlPrefix() {
        return Constants.GET_HOME_FOOTERLINKS;
    }
}
