 ...
 */
public class SelectMyCourseTransaction extends GetTransaction {

    public SelectMyCourseTransaction(JSONObject jsonObject, Context context) {
    ...
    protected String getUrlPrefix() {
        return Constants.GET_CATEGORY_ALL;
    }
}
