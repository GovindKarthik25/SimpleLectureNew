 ...
 */
public class BillingAddressTransaction extends PostTransaction {

    JSONObject jsonObject;

    public BillingAddressTransaction(JSONObject jsonObject, Context context) {
    ...
    protected String getUrlPrefix() {
        return Constants.GET_BILLINGADDRESSSAVE;
    }
}
