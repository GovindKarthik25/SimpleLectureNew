...
public class DashboardTestPaperTransaction extends GetTransaction {

    private String userID;

    public DashboardTestPaperTransaction(JSONObject jsonObject, Context context, String userId) {
