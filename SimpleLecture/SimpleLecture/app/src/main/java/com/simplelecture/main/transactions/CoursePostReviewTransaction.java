 ...
 */
public class CoursePostReviewTransaction extends PostTransaction {

    private final String headerVal;
    JSONObject jsonObject;

    public CoursePostReviewTransaction(JSONObject jsonObject, Context context, String token) {
    ...
    protected String getUrlPrefix() {
        return Constants.GET_COURSEPOSTREVIEW;
    }
