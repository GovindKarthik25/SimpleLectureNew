...
public class CoursesAdapter extends RecyclerView.Adapter<CoursesAdapter.MyViewHolder> {
    ...
    public CoursesAdapter(Activity activty, List<String> courseCombos) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.courses_item_view, parent, false);
